#!/bin/bash
kubectl get deployments.apps |grep -v '0/'| grep -v NAME|grep -v debug| awk '{print $1}'| sed -n 33,47p| sort > /home/brlink/container-name.txt
seq 33 47 > /home/brlink/grafanId.txt
seq 933 947 > /home/brlink/alertname.txt
